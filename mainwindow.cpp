...
static QString capacityLabel(int gb) {
  if (gb >= 1024 && gb % 1024 == 0)
    return QStringLiteral("%1TB").arg(gb / 1024);
...
static const CatRow kCatalogRows[] = {
    ...
    {"MG694J/A", "iPhone 17", 256, "ミストブルー", "2025-09-19",
     "4549995649178"},
    ...
    {"MG6F4J/A", "iPhone 17", 512, "ミストブルー", "2025-09-19",
     "4549995649222"},
    {"MG6G4J/A", "iPhone 17", 512, "ラベンダー", "2025-09-19", "4549995649239"},
    {"MG6H4J/A", "iPhone 17", 512, "セージ", "2025-09-19", "4549995649246"},
    {"MG854J/A", "iPhone 17 Pro", 256, "シルバー", "2025-09-19",
     "4549995648294"},
    {"MG864J/A", "iPhone 17 Pro", 256, "コズミックオレンジ", "2025-09-19",
     "4549995648300"},
    {"MG874J/A", "iPhone 17 Pro", 256, "ディープブルー", "2025-09-19",
     "4549995648317"},
    {"MG894J/A", "iPhone 17 Pro", 512, "シルバー", "2025-09-19",
     "4549995648324"},
    {"MG8A4J/A", "iPhone 17 Pro", 512, "コズミックオレンジ", "2025-09-19",
     "4549995648331"},
    {"MG8C4J/A", "iPhone 17 Pro", 512, "ディープブルー", "2025-09-19",
     "4549995648348"},
    {"MG8D4J/A", "iPhone 17 Pro", 1024, "シルバー", "2025-09-19",
     "4549995648355"},
    {"MG8E4J/A", "iPhone 17 Pro", 1024, "コズミックオレンジ", "2025-09-19",
     "4549995648362"},
    {"MG8F4J/A", "iPhone 17 Pro", 1024, "ディープブルー", "2025-09-19",
     "4549995648379"},
    {"MFY84J/A", "iPhone 17 Pro Max", 256, "シルバー", "2025-09-19",
     "4549995649284"},
    {"MFY94J/A", "iPhone 17 Pro Max", 256, "コズミックオレンジ", "2025-09-19",
     "4549995649291"},
    {"MFYA4J/A", "iPhone 17 Pro Max", 256, "ディープブルー", "2025-09-19",
     "4549995649307"},
    {"MFYC4J/A", "iPhone 17 Pro Max", 512, "シルバー", "2025-09-19",
     "4549995649314"},
    {"MFYD4J/A", "iPhone 17 Pro Max", 512, "コズミックオレンジ", "2025-09-19",
     "4549995649321"},
    {"MFYE4J/A", "iPhone 17 Pro Max", 512, "ディープブルー", "2025-09-19",
     "4549995649338"},
    {"MFYF4J/A", "iPhone 17 Pro Max", 1024, "シルバー", "2025-09-19",
     "4549995649345"},
    {"MFYG4J/A", "iPhone 17 Pro Max", 1024, "コズミックオレンジ", "2025-09-19",
     "4549995649352"},
    {"MFYH4J/A", "iPhone 17 Pro Max", 1024, "ディープブルー", "2025-09-19",
     "4549995649369"},
    {"MFYJ4J/A", "iPhone 17 Pro Max", 2048, "シルバー", "2025-09-19",
     "4549995649376"},
    {"MFYK4J/A", "iPhone 17 Pro Max", 2048, "コズミックオレンジ", "2025-09-19",
     "4549995649383"},
    {"MFYL4J/A", "iPhone 17 Pro Max", 2048, "ディープブルー", "2025-09-19",
     "4549995649390"},
    {"MG274J/A", "iPhone Air", 256, "スペースブラック", "2025-09-19",
     "4549995647501"},
    {"MG284J/A", "iPhone Air", 256, "クラウドホワイト", "2025-09-19",
     "4549995647518"},
    {"MG294J/A", "iPhone Air", 256, "ライトゴールド", "2025-09-19",
     "4549995647525"},
    {"MG2A4J/A", "iPhone Air", 256, "スカイブルー", "2025-09-19",
     "4549995647532"},
    {"MG2C4J/A", "iPhone Air", 512, "スペースブラック", "2025-09-19",
     "4549995647549"},
    {"MG2D4J/A", "iPhone Air", 512, "クラウドホワイト", "2025-09-19",
     "4549995647556"},
    {"MG2E4J/A", "iPhone Air", 512, "ライトゴールド", "2025-09-19",
     "4549995647563"},
    {"MG2F4J/A", "iPhone Air", 512, "スカイブルー", "2025-09-19",
     "4549995647570"},
    {"MG2G4J/A", "iPhone Air", 1024, "スペースブラック", "2025-09-19",
     "4549995647587"},
    {"MG2H4J/A", "iPhone Air", 1024, "クラウドホワイト", "2025-09-19",
     "4549995647594"},
    {"MG2J4J/A", "iPhone Air", 1024, "ライトゴールド", "2025-09-19",
     "4549995647600"},
    {"MG2K4J/A", "iPhone Air", 1024, "スカイブルー", "2025-09-19",
     "4549995647617"},
};
...
static const QHash<QString, QString> &getOtherProductsJanMap() {
  static const QHash<QString, QString> map = []() {
    ...
    m.insert("4549995526769",
             "iPad mini (A17 Pro) Cellular 128GB スペースグレイ");
    m.insert("4549995526776", "iPad mini (A17 Pro) Cellular 128GB ブルー");
    m.insert("4549995526783",
             "iPad mini (A17 Pro) Cellular 128GB スターライト");
    m.insert("4549995526790", "iPad mini (A17 Pro) Cellular 128GB パープル");
    m.insert("4549995526806",
             "iPad mini (A17 Pro) Cellular 256GB スペースグレイ");
    m.insert("4549995526813", "iPad mini (A17 Pro) Cellular 256GB ブルー");
    m.insert("4549995526820",
             "iPad mini (A17 Pro) Cellular 256GB スターライト");
    m.insert("4549995526837", "iPad mini (A17 Pro) Cellular 256GB パープル");
    m.insert("4549995530698",
             "iPad mini (A17 Pro) Cellular 512GB スペースグレイ");
    m.insert("4549995530704", "iPad mini (A17 Pro) Cellular 512GB ブルー");
    m.insert("4549995530711",
             "iPad mini (A17 Pro) Cellular 512GB スターライト");
    ...
    m.insert("4549995555752",
             "iPad Air (M3) 11\" Cellular 128GB スペースグレイ");
    ...
    m.insert("4549995555790",
             "iPad Air (M3) 11\" Cellular 256GB スペースグレイ");
    ...
    m.insert("4549995555837",
             "iPad Air (M3) 11\" Cellular 512GB スペースグレイ");
    ...
    m.insert("4549995556834",
             "iPad Air (M3) 13\" Cellular 128GB スペースグレイ");
    ...
    m.insert("4549995556872",
             "iPad Air (M3) 13\" Cellular 256GB スペースグレイ");
    ...
    m.insert("4549995556919",
             "iPad Air (M3) 13\" Cellular 512GB スペースグレイ");
    ...
    m.insert("4549995616842",
             "iPad Pro (M5) 11\" Cellular 256GB スペースブラック");
    m.insert("4549995616880", "iPad Pro (M5) 11\" Cellular 256GB シルバー");
    m.insert("4549995616927",
             "iPad Pro (M5) 11\" Cellular 512GB スペースブラック");
    m.insert("4549995616965", "iPad Pro (M5) 11\" Cellular 512GB シルバー");
    m.insert("4549995617009",
             "iPad Pro (M5) 11\" Cellular 1TB スペースブラック");
    m.insert("4549995617047", "iPad Pro (M5) 11\" Cellular 1TB シルバー");
    m.insert("4549995617160",
             "iPad Pro (M5) 11\" Cellular 2TB スペースブラック");
    m.insert("4549995617207", "iPad Pro (M5) 11\" Cellular 2TB シルバー");
    m.insert("4549995617085",
             "iPad Pro (M5) 11\" Cellular 1TB Nano スペースブラック");
    m.insert("4549995617122", "iPad Pro (M5) 11\" Cellular 1TB Nano シルバー");
    m.insert("4549995617245",
             "iPad Pro (M5) 11\" Cellular 2TB Nano スペースブラック");
    ...
    m.insert("4549995617320",
             "iPad Pro (M5) 13\" Cellular 256GB スペースブラック");
    m.insert("4549995617368", "iPad Pro (M5) 13\" Cellular 256GB シルバー");
    m.insert("4549995617405",
             "iPad Pro (M5) 13\" Cellular 512GB スペースブラック");
    m.insert("4549995617443", "iPad Pro (M5) 13\" Cellular 512GB シルバー");
    m.insert("4549995617481",
             "iPad Pro (M5) 13\" Cellular 1TB スペースブラック");
    m.insert("4549995617528", "iPad Pro (M5) 13\" Cellular 1TB シルバー");
    m.insert("4549995617641",
             "iPad Pro (M5) 13\" Cellular 2TB スペースブラック");
    m.insert("4549995617689", "iPad Pro (M5) 13\" Cellular 2TB シルバー");
    m.insert("4549995617566",
             "iPad Pro (M5) 13\" Cellular 1TB Nano スペースブラック");
    m.insert("4549995617603", "iPad Pro (M5) 13\" Cellular 1TB Nano シルバー");
    m.insert("4549995617726",
             "iPad Pro (M5) 13\" Cellular 2TB Nano スペースブラック");
...
static bool seedCatalogIfEmpty(QSqlDatabase &db) {
  QSqlQuery qc(db);
  if (!qc.exec("SELECT COUNT(*) FROM catalog"))
    return false;
  if (!qc.next())
    return false;
  if (qc.value(0).toInt() > 0)
    return true; // 已有数据，无需导入

  if (!db.transaction())
    return false;
  QSqlQuery qi(db);
  qi.prepare("INSERT OR IGNORE INTO catalog("
             " part_number, model_name, capacity_gb, color, release_date, jan, "
             "color_hex"
             ") VALUES(?,?,?,?,?,?,?)");
  for (const auto &r : kCatalogRows) {
    ...
    qi.addBindValue(
        colorHexFor(QString::fromUtf8(r.model), QString::fromUtf8(r.color)));
    if (!qi.exec()) {
...
static QString
displayNameForJan(const QSqlDatabase &db, // <== 这里改成 const 引用
                  const QString &jan, QString *colorHexOut = nullptr) {
  QSqlQuery q(db);
...
static void setItemColorDot(QStandardItem *it, const QString &hex,
  ...
  const int diameter =
      static_cast<int>(18 * scale + 0.5); // 基准 18 像素，根据 DPI 放大

  it->setData(QIcon(makeColorDotPixmap(QColor(hex), diameter)),
              Qt::DecorationRole);
}
...
// ====================== 工具：fit + 额外放大 ======================
static void fitAndZoom(QGraphicsView *view, double baseZoom = 1.3,
...
// —— 特殊码 —— //
static const QString kCodeToSearch =
    QStringLiteral("2222222222222"); // 跳到 検索(lineEdit_6)
static const QString kCodeToRegister =
    QStringLiteral("5555555555555"); // 入荷登録：搜索/仮登録 -> lineEdit
static const QString kCodeToTemp =
    QStringLiteral("3333333333333"); // 跳到 仮登録(lineEdit_4)
static const QString kCodeResetCount =
    QStringLiteral("1111111111111"); // 计数器2清零
static const QString kCodeFlushAll =
    QStringLiteral("4444444444444"); // 仮登録列表批量落库
static const QString kCodeExcelExport =
    QStringLiteral("7777777777777"); // Excel出力
static const QString kCodeExcelOpen =
    QStringLiteral("8888888888888"); // Excel表示

// —— 工具：仅包含某种来源（优先读 RoleKind，兼容旧文本）—— //
static bool modelOnlyHasPrefix(const QStandardItemModel *model,
                               const QString &kindTag) {
...
static bool ensureExactLenAndMark(QLineEdit *w, int expected, QStatusBar *bar,
                                  const QString &name) {
  ...
  if (bar)
    bar->showMessage(QStringLiteral("%1 には %2 桁数が必要，クリアしました。")
                         .arg(name)
                         .arg(expected),
                     2500);
  return false;
...
// ====================== 焦点高亮 ======================
FocusHighlighter::FocusHighlighter(const QList<QLineEdit *> &targets,
                                   QObject *parent)
...
// ====================== 限制输入域 ======================
ScannerOnlyGuard::ScannerOnlyGuard(const QList<QLineEdit *> &allowed,
                                   QObject *parent)
    : QObject(parent) {
  for (auto *w : allowed)
    m_allowed.insert(w);
...
bool ScannerOnlyGuard::eventFilter(QObject *obj, QEvent *event) {
  ...
  // Update 2026-02-17: Allow QPlainTextEdit (for V3/V4 bulk input) to receive
  // digits as it is not in m_allowed (which only stores QLineEdit*)
  if (qobject_cast<QPlainTextEdit *>(fw)) {
    inAllowed = true;
  }
...
MainWindow::MainWindow(QWidget *parent)
    : QMainWindow(parent), ui(new Ui::MainWindow),
      ...
      m_modelTab2(new QStandardItemModel(this)), m_highlighter(nullptr),
      m_guard(nullptr),
      m_actionDelete(new QAction(QStringLiteral("削除"), this)),
      m_tab2Counter(0), m_networkManager(new QNetworkAccessManager(this)) {
  ui->setupUi(this);
  ...
  setSvgToView(ui->graphicsView_9,
               QStringLiteral(":/Temporary_Registration.svg"));
  setSvgToView(ui->graphicsView_10,
               QStringLiteral(":/Temporary_Registration_Write.svg"));
  ...
  // Update 2026-02-17:Added lineEdit_10 (JAN) and lineEdit_11 (IMEI) to allow
  // scanner input
  m_scannerEdits = {
      ui->lineEdit,    ui->lineEdit_2, ui->lineEdit_6,
      ui->lineEdit_5,  ui->lineEdit_4, ui->lineEdit_3,
      ui->lineEdit_10, ui->lineEdit_11 // Tab 2 inputs
  };
  ...
  // 应用级扫码限制
  // Update 2026-02-17: Modified to allow QPlainTextEdit as well
  ...
  if (!initDatabase() && ui->statusbar)
    ui->statusbar->showMessage(
        QStringLiteral("データベースの初期化に失敗しました。権限/"
                       "パスを確認してください。"),
        4000);
  ...
  // 记住状态栏默认样式
  m_statusDefaultStyle =
      ui->statusbar ? ui->statusbar->styleSheet() : QString();
...
bool MainWindow::writeExportedItemsSheet(QXlsx::Document &xlsx,
  ...
  Format tdL;
  tdL.setBorderStyle(Format::BorderThin);
  Format tdC = tdL;
  ...
  auto mergeAndWrite = [&](int r1, int c1, int r2, int c2, const QVariant &v,
                           const Format &f) {
  ...
  // 汇总表表头（第3行）：A-B:JAN(合并), C:Product, D:(空), E:Qty, F:Unit Price,
  // G:Total Amount
  ...
  if (summaryDataEndRow >= summaryDataStartRow) {
    const QString totalSumFormula = QStringLiteral("=SUM(G%1:G%2)")
...
bool MainWindow::writeWs3Sheet(QXlsx::Document &xlsx,
  ...
  // 不要“社内番号”
  const QStringList headers = {QStringLiteral("会員番号"),
                               QStringLiteral("仕入れ先"),
  ...
  for (const auto &e : rows) {
    auto &a = agg[e.jan];
    if (a.product.isEmpty())
      a.product = e.productName; // 已是“机型 容量 颜色”
    a.qty += e.qty;              // 逐条=1
  }
...
void MainWindow::exportToExcel() {
  ...
  if (rows.isEmpty()) {
    if (ui->statusbar)
      ui->statusbar->showMessage(
          QStringLiteral("現在のセッションに「入荷登録」の記録がなく、生成され"
                         "ていません。"),
          2500);
    return;
  }
  ...
  if (!xlsx.saveAs(path)) {
    if (ui->statusbar)
      ui->statusbar->showMessage(QStringLiteral("Excel出力失败。"), 2500);
    return;
  }
...
void MainWindow::sendPostRequest(const QVector<ExportRow> &rows) {
  ...
  // 构建网络请求
  QNetworkRequest request(QUrl("https://data.yamaguchi.lan/api/aggregation/"
                               "legal-person-offline/create-with-inventory/"));
  ...
  request.setRawHeader(
      "Authorization",
      "Bearer "
      "FAZEHBZu0g2o3sRfQ58MxRC0w0htdUoPaLDN8R3ku8dJxk5exDgEUC1GtbJhwWWJKr4s8E");

  // 加载自定义 CA 证书 (caddy-ca-bundle.crt)
  QFile certFile(QCoreApplication::applicationDirPath() +
                 "/caddy-ca-bundle.crt");
  if (certFile.open(QIODevice::ReadOnly)) {
    QSslConfiguration outputConfig = request.sslConfiguration();

    // 获取默认配置的 CA 列表
    QList<QSslCertificate> caList = outputConfig.caCertificates();

    // 读取并追加自定义证书
    const QByteArray certData = certFile.readAll();
    QList<QSslCertificate> customCerts =
        QSslCertificate::fromData(certData, QSsl::Pem);
    caList.append(customCerts);

    // 更新配置
    outputConfig.setCaCertificates(caList);
    request.setSslConfiguration(outputConfig);
    certFile.close();
  } else {
    qWarning() << "Failed to open caddy-ca-bundle.crt:"
...
void MainWindow::initValidators() {
  ...
  ui->lineEdit->setValidator(
      new QRegularExpressionValidator(rx13, ui->lineEdit));
  ui->lineEdit_6->setValidator(
      new QRegularExpressionValidator(rx13, ui->lineEdit_6));
  ui->lineEdit_4->setValidator(
      new QRegularExpressionValidator(rx13, ui->lineEdit_4));
  ui->lineEdit_2->setValidator(
      new QRegularExpressionValidator(rx15, ui->lineEdit_2));
  ui->lineEdit_3->setValidator(
      new QRegularExpressionValidator(rx15, ui->lineEdit_3));
  ui->lineEdit_5->setValidator(
      new QRegularExpressionValidator(rx15, ui->lineEdit_5));
}

void MainWindow::initConnections() {
  // 入荷登録
  connect(ui->lineEdit, &QLineEdit::returnPressed, this,
          &MainWindow::onReg1Enter);
  connect(ui->lineEdit_2, &QLineEdit::returnPressed, this,
          &MainWindow::onReg2Enter);

  // 検索
  connect(ui->lineEdit_6, &QLineEdit::returnPressed, this,
          &MainWindow::onSearch1Enter);
  connect(ui->lineEdit_5, &QLineEdit::returnPressed, this,
          &MainWindow::onSearch2Enter);

  // 仮登録
  connect(ui->lineEdit_4, &QLineEdit::returnPressed, this,
          &MainWindow::onTemp1Enter);
  connect(ui->lineEdit_3, &QLineEdit::returnPressed, this,
          &MainWindow::onTemp2Enter);
  ...
  if (ui->lineEdit_10)
    connect(ui->lineEdit_10, &QLineEdit::returnPressed, this,
            &MainWindow::onTab2JanEnter);
  if (ui->lineEdit_11)
    connect(ui->lineEdit_11, &QLineEdit::returnPressed, this,
            &MainWindow::onTab2ImeiEnter);

  // tab_2: pushButton_2 Excel导出
  if (ui->pushButton_2)
    connect(ui->pushButton_2, &QPushButton::clicked, this,
            &MainWindow::exportTab2ToExcel);

  // Menu Actions
  if (ui->action1)
    connect(ui->action1, &QAction::triggered, this,
            &MainWindow::onActionNewSession);
  if (ui->action3)
    connect(ui->action3, &QAction::triggered, this,
            &MainWindow::onActionLoadLastSession);

  // Deletion Feature Setup
  m_actionDelete->setEnabled(false);
  if (ui->menu) {
    ui->menu->addAction(m_actionDelete);
  }
  connect(m_actionDelete, &QAction::triggered, this,
          &MainWindow::onActionDeleteSelected);

  // Enable multi-selection and context menu for list views
  ui->listView_2->setSelectionMode(QAbstractItemView::ExtendedSelection);
  ui->listView_3->setSelectionMode(QAbstractItemView::ExtendedSelection);
  ui->listView_2->setContextMenuPolicy(Qt::CustomContextMenu);
  ui->listView_3->setContextMenuPolicy(Qt::CustomContextMenu);

  connect(ui->listView_2, &QListView::customContextMenuRequested, this,
          &MainWindow::onListViewContextMenu);
  connect(ui->listView_3, &QListView::customContextMenuRequested, this,
          &MainWindow::onListViewContextMenu);
...
// ====================== SVG 显示 ======================
void MainWindow::setSvgToView(QGraphicsView *view, const QString &qrcPath,
...
// ====================== 列表与状态栏 ======================
QString MainWindow::formatRecord(const QString &prefix,
...
void MainWindow::addToListWithSource(const QString &text, ListSource src,
...
void MainWindow::showStatusOk(const QString &text) {
  ...
  ui->statusbar->setStyleSheet(
      QStringLiteral("QStatusBar{ color:#0a6d2a; }")); // 深绿色
...
bool MainWindow::ensureSchema() {
  ...
  if (!q.exec("CREATE TABLE IF NOT EXISTS inbound ("
  ...
  if (!q.exec("CREATE UNIQUE INDEX IF NOT EXISTS uq_inbound_sess_kind_imei "
              "ON inbound(session_id, kind, imei15);")) {
    qWarning() << q.lastError();
    return false;
  }

  if (!q.exec("CREATE TABLE IF NOT EXISTS entry_log ("
              "  id INTEGER PRIMARY KEY AUTOINCREMENT,"
              "  session_id TEXT NOT NULL,"
              "  type TEXT NOT NULL,"
              "  left_code TEXT,"
  ...
  if (!q.exec("CREATE TABLE IF NOT EXISTS catalog ("
              "  id INTEGER PRIMARY KEY AUTOINCREMENT,"
  ...
  q.exec("CREATE UNIQUE INDEX IF NOT EXISTS uq_catalog_part ON "
         "catalog(part_number);");
...
bool MainWindow::insertInboundRow(const QString &kind, const QString &code13,
                                  const QString &imei15, QString *errText) {
  QSqlQuery q(m_db);
  q.prepare(
      "INSERT INTO inbound(session_id, kind, code13, imei15) VALUES(?,?,?,?)");
  q.addBindValue(m_sessionId);
  q.addBindValue(kind);
...
bool MainWindow::insertEntryLogRow(const QString &type, const QString &leftCode,
                                   const QString &rightCode) {
  QSqlQuery q(m_db);
  q.prepare("INSERT INTO entry_log(session_id, type, left_code, right_code) "
            "VALUES(?,?,?,?)");
  q.addBindValue(m_sessionId);
  q.addBindValue(type);
...
bool MainWindow::existsInboundImeiInCurrentSession(
    const QString &imei15) const {
  QSqlQuery q(m_db);
  q.prepare("SELECT 1 FROM inbound WHERE session_id=? AND kind='入荷登録' AND "
            "imei15=? LIMIT 1");
  q.addBindValue(m_sessionId);
  q.addBindValue(imei15);
  if (!q.exec())
...
bool MainWindow::hasTempInListView() const {
  for (int r = 0; r < m_model->rowCount(); ++r) {
    ...
    if (!it)
      continue;
    const QString roleKind = it->data(RoleKind).toString();
    if (roleKind == QStringLiteral("仮登録"))
      return true;
    if (roleKind.isEmpty() && it->text().contains(QStringLiteral("[仮登録]")))
      return true; // 兼容
  }
  return false;
}
...
bool MainWindow::flushAllListItemsToDb() {
  ...
  for (int r = 0; r < m_model->rowCount(); ++r) {
    ...
    if (origKind.isEmpty() || a.isEmpty() || b.isEmpty())
      continue;
    if (origKind != QStringLiteral("入荷登録") &&
        origKind != QStringLiteral("仮登録"))
      continue;
...
void MainWindow::startNewSession() {
  ...
  if (ui->label_13)
    ui->label_13->setText(QStringLiteral("検索結果"));

  if (ui->statusbar)
    ui->statusbar->showMessage(QStringLiteral("新しい操作を開始しました。"),
                               1500);
}
...
void MainWindow::loadSession(const QString &sessionId) {
  ...
  if (ui->statusbar)
    ui->statusbar->showMessage(
        QStringLiteral("セッションを読み込みました：") + m_sessionId, 2000);
}
...
void MainWindow::chooseOrCreateSessionOnStartup() {
  ...
  if (!lastSid.isEmpty()) {
    ...
    box.setText(
        QStringLiteral("前回の操作（セッションID：%1）を検出しました。\n"
                       "前回の操作を続行しますか？")
            .arg(lastSid));
    QPushButton *btnContinue = box.addButton(
        QStringLiteral("前回の操作を続行する"), QMessageBox::AcceptRole);
    QPushButton *btnNew = box.addButton(QStringLiteral("新しい操作を開始する"),
...
void MainWindow::onActionNewSession() {
  QMessageBox::StandardButton reply = QMessageBox::question(
      ...
      QStringLiteral("現在の操作を終了し、新しい操作を開始しますか？"),
...
void MainWindow::onActionLoadLastSession() {
  QMessageBox::StandardButton reply = QMessageBox::question(
      this, QStringLiteral("確認"),
      QStringLiteral("現在の操作を破棄し、最近の記録を読み込みますか？"),
      QMessageBox::Yes | QMessageBox::No);
  if (reply != QMessageBox::Yes) {
    return;
  }
  ...
  QSqlQuery q(m_db);
  q.prepare("SELECT session_id FROM inbound WHERE session_id != ? ORDER BY id "
            "DESC LIMIT 1");
  q.addBindValue(m_sessionId);

  if (q.exec() && q.next()) {
    QString lastValidSid = q.value(0).toString();
    loadSession(lastValidSid);
  } else {
    QMessageBox::information(this, QStringLiteral("情報"),
                             QStringLiteral("以前の記録が見つかりません。"));
  }
}
...
void MainWindow::onListViewContextMenu(const QPoint &pos) {
  ...
  contextMenu.addAction(m_actionDelete);
...
void MainWindow::updateDeleteActionState() {
  ...
  if (ui->listView_2->selectionModel()->hasSelection())
    hasSelection = true;
  if (ui->listView_3->selectionModel()->hasSelection())
    hasSelection = true;
  m_actionDelete->setEnabled(hasSelection);
}

void MainWindow::onActionDeleteSelected() {
  QModelIndexList selected2 =
      ui->listView_2->selectionModel()->selectedIndexes();
  QModelIndexList selected3 =
      ui->listView_3->selectionModel()->selectedIndexes();

  if (selected2.isEmpty() && selected3.isEmpty())
    return;

  int total = selected2.size() + selected3.size();
  QMessageBox::StandardButton reply = QMessageBox::question(
      this, QStringLiteral("削除の確認"),
      QStringLiteral("%1件の記録を削除しますか？").arg(total),
      QMessageBox::Yes | QMessageBox::No);
  ...
  auto deleteFromModel = [&](QStandardItemModel *model,
    ...
    for (const QModelIndex &index : selected) {
      ...
      QString jan = item->data(RoleCode13).toString();
      QString imei = item->data(RoleImei15).toString();

      QSqlQuery q(m_db);
      q.prepare(
          "DELETE FROM inbound WHERE session_id=? AND code13=? AND imei15=?");
      q.addBindValue(m_sessionId);
      q.addBindValue(jan);
      q.addBindValue(imei);

      if (!q.exec()) {
        qWarning() << "Failed to delete from inbound: " << q.lastError();
        error = true;
      } else {
  ...
  if (!selected2.isEmpty())
    deleteFromModel(m_modelSession, selected2);
  if (!selected3.isEmpty())
    deleteFromModel(m_modelTab2, selected3);

  if (error) {
    m_db.rollback();
    QMessageBox::warning(this, QStringLiteral("エラー"),
                         QStringLiteral("一部の記録の削除に失敗しました。"));
  } else {
    m_db.commit();
    updateLcdFromDb();
    refreshSessionRecordsView();
    refreshTab2ListView();
    if (ui->statusbar)
      ui->statusbar->showMessage(QStringLiteral("選択した記録を削除しました。"),
                                 2000);
    m_actionDelete->setEnabled(false);
  }
}
...
void MainWindow::refreshSessionRecordsView() {
  ...
  while (q.next()) {
    ...
    const QString baseText =
        QStringLiteral("%1  [%2] %3 / %4").arg(ts, kind, left, i15);
...
void MainWindow::onReg1Enter() {
  ...
  if (v == kCodeResetCount) {
    ...
    if (ui->statusbar)
      ui->statusbar->showMessage(QStringLiteral("カウンタ2はリセット済み"),
                                 2000);
    ui->lineEdit->clear();
    return;
  }
  if (v == kCodeToSearch) {
    ...
    if (ui->statusbar)
      ui->statusbar->showMessage(
          QStringLiteral("ショートカットキー：検索へ移動。"), 1500);
    return;
  }
  if (v == kCodeToTemp) {
    ui->lineEdit->clear();
    ...
    if (ui->statusbar)
      ui->statusbar->showMessage(
          QStringLiteral("ショートカットコード：仮登録へ移動。"), 1500);
    return;
  }
  if (v == kCodeExcelExport) {
    ui->lineEdit->clear();
    exportToExcel();
    return;
  }
  ...
  // 13 位长度校验
  if (!ensureExactLenAndMark(ui->lineEdit, 13, ui->statusbar,
                             QStringLiteral("入荷登録(JAN)"))) {
  ...
  if (disp.isEmpty()) {
    ...
    if (ui->statusbar)
      ui->statusbar->showMessage(
          QStringLiteral("入荷登録：JAN未登録商品、未入庫。"), 2500);

    if (ui->label) {
      ui->label->setText(QStringLiteral("未登録 JAN"));
      ui->label->setStyleSheet(
          QStringLiteral("QLabel{ color:#d32f2f; font-weight:600; }"));
    }
...
void MainWindow::onReg2Enter() {
  ...
  // ---- IMEI 长度校验（必须 15 位）----
  if (!ensureExactLenAndMark(ui->lineEdit_2, 15, ui->statusbar,
                             QStringLiteral("入荷登録(IMEI)"))) {
  ...
  if (a.size() != 13) {
    ...
    if (ui->statusbar)
      ui->statusbar->showMessage(
          QStringLiteral("入荷登録(JAN)に13桁を入力してください。"), 2500);
  ...
  if (existsInboundImeiInCurrentSession(b)) {
    ...
    if (ui->statusbar)
      ui->statusbar->showMessage(
          QStringLiteral("入荷登録：IMEI 重複，未记录。"), 2000);
  ...
  QString err;
  const bool okInbound =
      insertInboundRow(QStringLiteral("入荷登録"), a, b, &err);
  const bool okLog = insertEntryLogRow(QStringLiteral("入荷登録"), a, b);
  if (!okInbound) {
    qWarning() << "insert inbound failed:" << err;
    if (ui->statusbar)
      ui->statusbar->showMessage(QStringLiteral("入荷登録：在庫登録失敗。"),
                                 2000);
    // 失败时也不再继续后续 UI 更新
    return;
  }
  ...
  if (m_lcd2Counter == 0) {
    ...
    QTimer::singleShot(1000, this,
                       [this]() { playSound(QStringLiteral("count_reset")); });
  }
  updateLcdFromDb();
  refreshSessionRecordsView();
  ...
  for (int r = 0; r < m_model->rowCount(); ++r) {
    if (auto *line = m_model->item(r)) {
      if (line->data(RoleKind).toString() == QStringLiteral("入荷登録"))
        ++regCount;
    }
  }
  if (regCount == 10) {
    ...
    if (ui->statusbar)
      ui->statusbar->showMessage(
          QStringLiteral("入荷登録：10件完了、リストをリセットしました。"),
          2000);
  }
...
void MainWindow::onTemp1Enter() {
  ...
  if (v == kCodeToSearch) {
    ...
    if (ui->statusbar)
      ui->statusbar->showMessage(
          QStringLiteral("ショートカットコード：検索へ移動。"), 1500);
    return;
  }
  if (v == kCodeToRegister) {
    ...
    if (ui->statusbar)
      ui->statusbar->showMessage(
          QStringLiteral("ショートカットコード：入荷登録(JAN)へ移動。"), 1500);
    return;
  }
  if (v == kCodeExcelExport) {
    ui->lineEdit_4->clear();
  ...
  // 13 位长度校验
  if (!ensureExactLenAndMark(ui->lineEdit_4, 13, ui->statusbar,
                             QStringLiteral("仮登録(JAN)"))) {
  ...
  if (disp.isEmpty()) {
    ...
    if (ui->statusbar)
      ui->statusbar->showMessage(
          QStringLiteral("仮登録：JAN未登録商品、未登録。"), 2500);
...
void MainWindow::onTemp2Enter() {
  ...
  if (b == kCodeToRegister) {
    ...
    if (ui->statusbar)
      ui->statusbar->showMessage(
          QStringLiteral("ショートコード：入荷登録（JAN）へ移動。"), 1500);
    return;
  }
  if (b == kCodeExcelExport) {
    ui->lineEdit_4->clear();
  ...
  // ---- IMEI 长度校验（必须 15 位）----
  if (!ensureExactLenAndMark(ui->lineEdit_3, 15, ui->statusbar,
                             QStringLiteral("仮登録(后码)"))) {
  ...
  if (a.size() != 13) {
    ...
    if (ui->statusbar)
      ui->statusbar->showMessage(
          QStringLiteral("请先在 仮登録(前码) 输入 13 位。"), 2500);
    playSound(QStringLiteral("jan_error"));
    return;
  }
  ...
  if (disp.isEmpty()) {
    ...
    if (ui->statusbar)
      ui->statusbar->showMessage(
          QStringLiteral("仮登録：JAN 未登録商品，未加入。"), 2500);
  ...
  if (dupNow) {
    ...
    if (ui->statusbar)
      ui->statusbar->showMessage(
          QStringLiteral("仮登録：IMEI 重复，已标红（不会入库）。"), 2000);
    playSound(QStringLiteral("imei_duplicate"));
    if (ui->label_8) {
...
void MainWindow::onSearch1Enter() {
  ...
  if (v == kCodeResetCount) {
    ...
    ui->lcdNumber_2->display(0);
    if (ui->statusbar)
      ui->statusbar->showMessage(QStringLiteral("计数器2 已清零。"), 1500);
    ui->lineEdit_6->clear();
    return;
  }
  if (v == kCodeToRegister) {
    ...
    if (ui->statusbar)
      ui->statusbar->showMessage(
          QStringLiteral("快捷码：跳到 入荷登録(前码)。"), 1500);
    return;
  }
  if (v == kCodeToTemp) {
    ui->lineEdit_6->clear();
    ...
    ui->lineEdit_4->selectAll();
    if (ui->statusbar)
      ui->statusbar->showMessage(QStringLiteral("快捷码：跳到 仮登録。"), 1500);
    return;
  }
  if (v == kCodeExcelExport) {
    ui->lineEdit_6->clear();
  ...
  if (!ensureExactLenAndMark(ui->lineEdit_6, 13, ui->statusbar,
                             QStringLiteral("検索(前码)"))) {
...
void MainWindow::onSearch2Enter() {
  ...
  if (!ensureExactLenAndMark(ui->lineEdit_5, 15, ui->statusbar,
                             QStringLiteral("検索(后码)"))) {
  ...
  if (a.size() != 13) {
    ...
    if (ui->statusbar)
      ui->statusbar->showMessage(
          QStringLiteral("请先在 検索(前码) 输入 13 位。"), 2500);
  ...
  for (int r = 0; r < m_modelSession->rowCount(); ++r) {
    if (auto *it = m_modelSession->item(r)) {
      if (it->data(RoleImei15).toString() == b) {
        hitRow = r;
        break;
      }
    }
  ...
  if (ui->statusbar)
    ui->statusbar->showMessage(QStringLiteral("検索：已更新列表。"), 1500);
...
void MainWindow::onResetClicked() {
  ...
  ui->lineEdit->setFocus();
  if (ui->statusbar)
    ui->statusbar->showMessage(QStringLiteral("已重置（计数器2 已清零）。"),
                               1500);
}

// ====================== tab_2: 解析V4格式 ======================
QVector<MainWindow::ParsedRecord> MainWindow::parseV4Line(const QString &line,
                                                          QStringList *errors) {
  ...
  const QStringList parts =
      normalized.split(QStringLiteral(","), Qt::SkipEmptyParts);
  ...
  for (const QString &part : parts) {
    ...
    if (p.startsWith(QStringLiteral("IMEI"), Qt::CaseInsensitive)) {
      ...
      if (imeiValue.size() == 15) {
        imeis.append(imeiValue);
      } else {
        if (errors)
          errors->append(
              QStringLiteral("IMEIは15桁である必要があります（現在：%1桁）")
                  .arg(imeiValue.size()));
      }
    }
  }
...
// ====================== tab_2: 解析V3格式 ======================
QVector<MainWindow::ParsedRecord> MainWindow::parseV3Line(const QString &line,
                                                          QStringList *errors) {
  QVector<ParsedRecord> results;
  ...
  for (const QString &part : parts) {
    ...
    if (p.startsWith('S') && p.size() == 11) {
      ...
      if (valid) {
        ...
        if (errors)
          errors->append(
              QStringLiteral("シリアル番号の形式が無効です：%1").arg(p));
      }
    } else if (p.startsWith('S') && p.size() != 11 &&
               !p.startsWith(QStringLiteral("SSCC"), Qt::CaseInsensitive) &&
               !p.startsWith(QStringLiteral("SCC"), Qt::CaseInsensitive)) {
      // 以S开头但不是11位，且不是SSCC/SCC字段
      if (errors)
        errors->append(
            QStringLiteral(
                "シリアル番号は11桁である必要があります（現在：%1桁）：%2")
                .arg(p.size())
                .arg(p));
    }
  }
...
void MainWindow::showTab2Error(const QString &text) {
  if (ui->label_3) {
    ...
    ui->label_3->setStyleSheet(
        QStringLiteral("QLabel{ color:#cc0000; }")); // 红色
  }
  if (ui->statusbar) {
    ui->statusbar->setStyleSheet(
        QStringLiteral("QStatusBar{ color:#cc0000; }")); // 红色
...
void MainWindow::refreshTab2ListView() {
  ...
  while (q.next()) {
    ...
    item->setData(jan, RoleCode13);
    item->setData(imei, RoleImei15);
    item->setData(QStringLiteral("入荷登録"), RoleKind);
...
void MainWindow::onPlainTextEnter() {
  ...
  if (text.startsWith(QStringLiteral("V4"), Qt::CaseInsensitive)) {
    ...
    showTab2Error(QStringLiteral(
        "未知のデータ形式です。V3またはV4で始まる必要があります。"));
  ...
  for (const ParsedRecord &rec : records) {
    ...
    // 写入数据库
    QString errText;
    if (insertInboundRow(QStringLiteral("入荷登録"), rec.jan, rec.imei,
                         &errText)) {
      ++successCount;
    } else {
  ...
  if (!errors.isEmpty() || duplicateCount > 0) {
    ...
    if (duplicateCount > 0) {
      allErrors.prepend(
          QStringLiteral(
              "重複：このIMEI/シリアル番号は既に登録されています（%1件）")
              .arg(duplicateCount));
    }
    ...
    if (successCount == 0) {
      if (ui->statusbar) {
        ui->statusbar->setStyleSheet(
            QStringLiteral("QStatusBar{ color:#cc0000; }"));
...
void MainWindow::showTab2Label2Log(const QString &text, bool isError) {
  ...
  if (isError) {
    ...
    ui->label_2->setStyleSheet(
        QStringLiteral("QLabel{ color:#0a6d2a; }")); // 绿色
  }
...
void MainWindow::onTab2JanEnter() {
  ...
  if (jan.size() != 13) {
    showTab2Label2Log(
        QStringLiteral("JANコードは13桁である必要があります（現在：%1桁）")
            .arg(jan.size()),
        true);
    playSound(QStringLiteral("jan_error"));
  ...
  if (!allDigits) {
    showTab2Label2Log(QStringLiteral("JANコードは数字のみである必要があります"),
                      true);
    playSound(QStringLiteral("jan_error"));
    ui->lineEdit_10->clear();
    ui->lineEdit_10->setFocus();
  ...
  if (productName.isEmpty()) {
    showTab2Label2Log(
        QStringLiteral("該当する商品が見つかりません：%1").arg(jan), true);
    playSound(QStringLiteral("jan_not_found"));
    ui->lineEdit_10->clear();
    ui->lineEdit_10->setFocus();
    return;
...
void MainWindow::onTab2ImeiEnter() {
  ...
  if (imei.size() != 15 && imei.size() != 11) {
    showTab2Label2Log(QStringLiteral("IMEI（15桁）またはシリアル番号（11桁）で"
                                     "ある必要があります（現在：%1桁）")
                          .arg(imei.size()),
                      true);
    playSound(QStringLiteral("imei_error"));
  ...
  if (imei.size() == 15) {
    ...
    if (!allDigits) {
      showTab2Label2Log(QStringLiteral("IMEIは数字のみである必要があります"),
                        true);
      playSound(QStringLiteral("imei_error"));
      ui->lineEdit_11->clear();
      ui->lineEdit_11->setFocus();
  ...
  if (imei.size() == 11) {
    ...
    if (!allAlphaNum) {
      showTab2Label2Log(
          QStringLiteral("シリアル番号は英数字のみである必要があります"), true);
      playSound(QStringLiteral("imei_error"));
      ui->lineEdit_11->clear();
      ui->lineEdit_11->setFocus();
      return;
  ...
  if (existsInboundImeiInCurrentSession(imei)) {
    showTab2Label2Log(
        QStringLiteral("重複：このIMEI/シリアル番号は既に登録されています"),
        true);
    playSound(QStringLiteral("imei_duplicate"));
    ui->lineEdit_11->clear();
    ui->lineEdit_11->setFocus();
  ...
  // 写入数据库
  QString errText;
  if (!insertInboundRow(QStringLiteral("入荷登録"), m_tab2PendingJan, imei,
                        &errText)) {
